...
@section('sidebar')
    <div class="container margin_60_35">
        <div class="row">
            ...
            <div class="col-md-3">
                <p><a href="list_page.html" class="btn_side">Trở về kết quả tìm kiếm</a></p>
                <div class="box_style_1">
                    <ul id="cat_nav">
                        <li><a href="#starters" class="active">Khai Vị <span>(141)</span></a></li>
                        <li><a href="#main_courses">Món Chính <span>(20)</span></a></li>
                        <li><a href="#beef">Món Đạm <span>(12)</span></a></li>
                        <li><a href="#desserts">Tráng Miệng <span>(11)</span></a></li>
                        <li><a href="#drinks">Thức Uống <span>(20)</span></a></li>
                    </ul>
                </div><!-- End box_style_1 -->
                <!-- NEED HELP -->
...
@section('content')
            <div class="col-md-6">
                <div class="box_style_2" id="main_menu">
                    <h2 class="inner">Thực Đơn</h2>
                    <h3 class="nomargin_top" id="starters">Khai Vị</h3>
                    <p>
                        (MÔ TẢ THỰC ĐƠN) Te ferri iisque aliquando pro, posse nonumes efficiantur in cum. Sensibus reprimique eu pro. Fuisset mentitum deleniti sit ea.
                    </p>
                    <table class="table table-striped cart-list">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-1.jpg')!!}" alt="thumb"></figure>
                            ...
                            <td class="options">
                                <div class="dropdown dropdown-options">
                                    ...
                                    <div class="dropdown-menu">
                                        <h5>Thêm lựa chọn</h5>
                                        <label>
                                            <input type="radio" value="option1" name="options_1" checked>Vừa <span>+ $3.30</span>
                                        </label>
                                        <label>
                                            <input type="radio" value="option2" name="options_1" >Lớn <span>+ $5.30</span>
                                        </label>
                                        <label>
                                            <input type="radio" value="option3" name="options_1" >Cực lớn <span>+ $8.30</span>
                                        </label>
                                        <h5>Đồ dùng thêm</h5>
                                        <label>
                                            <input type="checkbox" value="">Thêm cà chua <span>+ $4.30</span>
                                        </label>
                                        <label>
                                            <input type="checkbox" value="">Thêm ớt <span>+ $2.50</span>
                                        </label>
                                        <a href="#0" class="add_to_basket">Thêm vào giỏ hàng</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-2.jpg')!!}" alt="thumb"></figure>
                                <h5>2. Fajitas</h5>
                                <p>
                                    Fuisset mentitum deleniti sit ea.
                                </p>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-3.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-4.jpg')!!}" alt="thumb"></figure>
                    ...
                    <hr>
                    <h3 id="main_courses">Món chính</h3>
                    <p>
                    ...
                    <table class="table table-striped cart-list ">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-5.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-6.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-7.jpg')!!}" alt="thumb"></figure>
                                <h5>7. Beef Taco</h5>
                                <p>
                                    Fuisset mentitum deleniti sit ea.
                                </p>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-8.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-9.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-10.jpg')!!}" alt="thumb"></figure>
                    ...
                    <table class="table table-striped cart-list ">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-11.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-12.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-13.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-14.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-15.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-16.jpg')!!}" alt="thumb"></figure>
                    ...
                    <table class="table table-striped cart-list ">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-17.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-18.jpg')!!}" alt="thumb"></figure>
                                <h5>18. Cheesecake</h5>
                                <p>
                                    Fuisset mentitum deleniti sit ea.
                                </p>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-19.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-20.jpg')!!}" alt="thumb"></figure>
                    ...
                    <table class="table table-striped cart-list ">
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-21.jpg')!!}" alt="thumb"></figure>
                                <h5>21. Coke 0.33L</h5>
                                <p>
                                    Fuisset mentitum deleniti sit ea.
                                </p>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-22.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-23.jpg')!!}" alt="thumb"></figure>
                        ...
                        <tr>
                            <td>
                                <figure class="thumb_menu_list"><img src="{!! asset('public/front/img/menu-thumb-24.jpg')!!}" alt="thumb"></figure>
